...
<template>
  <div :class="cn('h-full v-stack min-h-0 bg-neutral-100 dark:bg-[#242424] animate-in fade-in slide-in-from-right-2 duration-300', props.class)">
    <!-- Submodule Header Panel -->
    <header class="p-6 border-b border-neutral-200 dark:border-neutral-800 bg-neutral-100 dark:bg-[#252526] h-stack justify-between shrink-0">
       <div class="h-stack gap-4">
         ...
         <div class="v-stack gap-0.5">
           ...
           <h2 class="text-sm font-bold text-neutral-900 dark:text-neutral-100 break-all select-text font-mono leading-tight">{{ path }}</h2>
         </div>
       </div>
       ...
       <div v-if="sha" class="v-stack items-end gap-1">
          ...
          <div class="px-2 py-0.5 bg-neutral-200 dark:bg-neutral-800 rounded text-[10px] font-mono text-neutral-600 dark:text-neutral-400 border border-neutral-300 dark:border-neutral-700 select-text">{{ sha.substring(0, 8) }}</div>
       </div>
    </header>

    <!-- Submodule Content -->
    <div class="flex-1 overflow-hidden relative">
       <div v-if="isSubmoduleLoading" class="absolute inset-0 v-stack center bg-neutral-100 dark:bg-[#242424] z-10">
       ...
       <div v-else class="flex-1 h-full center v-stack text-neutral-600 p-8 bg-neutral-100 dark:bg-[#242424]">
