...
<template>
  <div class="flex flex-col">
    <div v-for="f in files" :key="f.path" 
         ...
         class="flex items-center gap-2 px-3 py-1.5 cursor-pointer hover:bg-neutral-800 transition-colors group"
         :class="selectedPath === f.path ? 'bg-[#143B66] text-white' : 'text-neutral-400'">
